...
function HomePage({position}) {
    ...
    const CellDataTop = [
            {
                ...
                header:'보도자료',
                date:'2022.12.30',
                title:'카카오메이커스, ‘제가버치’ 프로젝트 X ‘배상면주가’ 콜라보 제품 출시',
                tag:['카카오메이커스','제가버치'],
            ...
            },
            {
                ...
                header:'보도자료',
                date:'2022.12.30',
                title:"카카오, '우리동네 단골시장 프로젝트' 수료식 및 우수상인 시상식 진행",
                tag:['우리동네단골시장','소신상인'],
    ...
    const CellDatalow = [
        ...
        },
        {
            ...
            header:'보도자료',
            date:'2022.12.20',
            title:'카카오메이커스, ‘새활용’ 프로젝트로 두 번째 기부... 취약계층 어르신 대상 카디건 전달',
            tag:['새활용프로젝트','카디건기부'],
    ...
    return (
        <Container>
            ...
            <Banner>
                ...
                <BannerButton>카카오 문의바로가기 <VscArrowRight/></BannerButton>
            ...
            <Cards>
                <CardContents BackgroundColor={'#fae100'}>
                    ...
                    <CardButton>서비스 바로가기 <VscArrowRight/></CardButton>
                    <CardIcons src='https://www.kakaocorp.com/page/bg_home_service.png' alt=''/>
                </CardContents>
                <CardContents BackgroundColor={'#3c64ff'}>
                    <CardTitle>세상만사에 관심이 많다면, 당신은 이미 카카오 크루</CardTitle>
                    <CardButton>인재영입 바로가기 <VscArrowRight/></CardButton>
